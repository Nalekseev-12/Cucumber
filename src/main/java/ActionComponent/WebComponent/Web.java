package ActionComponent.WebComponent;

import ActionComponent.browser.Browser;
import ActionComponent.browser.BrowserType;
...
public class Web {
    ...
    private Logger logger = LogManager.getLogger(Web.class);
